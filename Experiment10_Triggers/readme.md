...
```
![Screenshot 2025-05-18 200538](https://github.com/user-attachments/assets/4b757800-24d7-4eac-9ce3-b63cf37c6d5d)
...
DELETE FROM sensitive_data WHERE data_id = 1;
  ```
![Screenshot 2025-05-18 200720](https://github.com/user-attachments/assets/d4aed857-7e07-455f-97b8-64d0c0d2efaf)
...
WHERE product_id = 101;
  ```
![Screenshot 2025-05-18 200807](https://github.com/user-attachments/assets/2cd514e3-9d0f-4ca3-88ef-de00f2f2f7de)
...
![Screenshot 2025-05-18 200850](https://github.com/user-attachments/assets/c0e15e3f-30fb-483b-a043-1c3358216347)
...
VALUES (2, 'Jane Smith', 4000);
  ```
![Screenshot 2025-05-18 200945](https://github.com/user-attachments/assets/7b064271-bdf3-452f-be54-c299feb0bf56)
